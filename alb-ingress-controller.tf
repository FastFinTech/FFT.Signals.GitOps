# locals {
#   #aws_alb_ingress_namespace = "ingress"
...
#     condition {
#       test     = "StringEquals"
#       variable = "${replace(data.aws_eks_cluster.signals.identity[0].oidc[0].issuer, "https://", "")}:sub"
#       values = [
#         "system:serviceaccount:${kubernetes_namespace.alb_ingress.metadata.0.name}:aws-alb-ingress-controller"
#       ]
#     }
#     principals {
#       identifiers = [
#         "arn:aws:iam::${data.aws_caller_identity.current.account_id}:oidc-provider/${replace(data.aws_eks_cluster.signals.identity[0].oidc[0].issuer, "https://", "")}"
#       ]
#       type = "Federated"
#     }
#   }
...
#   metadata {
#     name      = "aws-alb-ingress-controller"
#     namespace = kubernetes_namespace.alb_ingress.metadata.0.name #var.k8s_namespace
...
#             "app.kubernetes.io/version" = "v${local.aws_alb_ingress_controller_version}"
#           },
#           #TODO: Check this, i removed it because we are not using that bar
#           #var.k8s_pod_labels
#           {}
#         )
#         # annotations = merge(
...
#         #     # when running on EKS.
#         #     "iam.amazonaws.com/role" = aws_iam_role.alb.arn
#         #   },
